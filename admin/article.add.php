...
<body>
	...
	<article>
		<h3>发布文章</h3>
		<form id="form" action="article.add.handle.php" method="post">
			<p>
				标题<input type="text" name="title" maxlength="100">
			</p>
			<p>
				作者<input type="text" name="author" maxlength="50">
			</p>
			<p>
				简介<textarea name="description" cols="100" rows="8"></textarea>
			</p>
			<p>
				内容<textarea name="content" cols="100" rows="10"></textarea>
			</p>
